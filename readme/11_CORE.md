...
|------------|-------------|
| مبادئ core، حدود الطبقات، هيكل core/ | `11_CORE.md` |
| REST، network، ApiService، Repository، Failure flow | `12_REST_API.md` |
| `ui/feedback/` أو feedback API | `20_WIDGETS.md` + `00_START_HERE.md` |
| `ui/locale/` أو locale API | `20_WIDGETS.md` + `00_START_HERE.md` |
| Pagination | `14_PAGINATION.md` |
| Widgets / theme / presentation paths | `20_WIDGETS.md` |
| Scripts، build/release، troubleshooting | `40_SCRIPTS.md` |
| Onboarding، هيكل lib/ | `00_START_HERE.md` + `10_ARCHITECTURE.md` |
| فهرس عام | `10_ARCHITECTURE.md` |

> `apigenerator.md` و`project_workflow.md` **محذوفان** — محتواهما مدمج في `12_REST_API.md` و`40_SCRIPTS.md`.
...
| `platform/features/` | `AppFeatures` — كل الأعلام. **خريطة الأذونات الأصلية تعيش بـ`scripts/sync_platform_permissions.dart` وحده** |
...
- `ui/error/` = عرض فقط — لا منطق، لا Dio
...
| الملف | الغرض |
|-------|--------|
| `readme/10_ARCHITECTURE.md` | فهرس + هيكل كامل + Future Ideas |
| `readme/12_REST_API.md` | REST workflow + import paths + common mistakes |
| `readme/14_PAGINATION.md` | pagination |
| `readme/20_WIDGETS.md` | widget placement + feedback + locale |
| `readme/40_SCRIPTS.md` | scripts + build/release + troubleshooting |
| `readme/00_START_HERE.md` | onboarding + feedback & locale API |
