...
| `modules/sync/` ([`sync.md`](sync.md)) | «ماذا فاتني وأنا أوفلاين؟» — الكلاينت يسحب | **مبنيّ** — مطفأ بـ`AppFeatures.offlineSync = false` |
...
> فكان يظهر بكل قائمة مجلدات وبشجرة `architecture.md` وبكل أداة تمشي على `lib/`
