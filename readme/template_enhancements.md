...
**آخر مزامنة من قرطاس: 2026-08-10** — نُقلت فيها الطبقة الأساسية (18 · 19 · 23 · 24 · 27 · 28 · 43).
...
| **16** | `ApiError.data` — حمولة إضافية اختيارية | 🔴 عالية | ✅ | **✅** | حقل اختياري على `core/foundation/contracts/` |
