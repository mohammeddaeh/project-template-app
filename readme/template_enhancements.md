...
> ⚠️ **هذه الوثيقة تصف ما يُضاف. وهناك ما هو مكسور الآن.**
> [`integration_audit.md`](integration_audit.md) — تدقيق 2026-08-11 لعقد الـwire بين `app_template` و`backend_template`.
> **خمسة أعطال قاطعة تمنع مسار الدخول من العمل** (أبرزها: الفرونت يقرأ `data.user` والباك يرسل `data.account`).
> **اقرأها قبل هذه الوثيقة** — بند P0 فيها يسبق كل بند هنا.
