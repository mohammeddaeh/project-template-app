...
import 'package:app_template/ui/widgets/placeholders/skeleton_templates.dart';
import 'package:app_template/ui/widgets/placeholders/skeleton_widget.dart';
...
class InitialLoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) => switch (style) {
    InitialLoadingStyle.spinner => const AppProgress.circular(
