...
import 'package:app_template/ui/widgets/placeholders/shimmer_loading_widget.dart';
...
class _PageLoadingIndicatorState extends State<PageLoadingIndicator>
  ...
  Widget _buildSpinner(BuildContext context) => const AppProgress.circular(
    dimension: 28,
    centered: true,
  ...
  Widget _buildLinearBar(BuildContext context) => const AppProgress.linear(
    height: 3,
